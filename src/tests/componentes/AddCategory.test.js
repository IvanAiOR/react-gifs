...
describe('Pruebas en <AddCategory/>', () => {
    ...
    test('debe probar si el input se guarda y ademas envía el submit una vez', () => {
        ...
        expect(setCategory).toHaveBeenCalled();//espera que se llame 
        expect(setCategory).toBeCalledWith(expect.any(Function));//espera que se llame 
